...
export default class ReactLeafletSearch extends MapControl {
    constructor(props, context) {
        ...
        this.handler = ({ event, payload }) => {
            if (event === "add") {
                ...
                this.props.SetPosition({currentPos:payload.latlng});
            }
            else {
    ...
    render() {
        return this.SearchInfo && this.state.search && this.props.showMarker ? (React.createElement(Marker, { draggable:true,ref: this.markerRef, icon: this.props.markerIcon || this.markerIcon, key: `marker-search-${this.state.search.toString()}`, position: this.state.search, onDragEnd:(e)=>{this.setState({search:e.target._latlng});this.props.SetPosition({currentPos:e.target._latlng});} }, this.props.showPopup && (this.props.popUp ? this.props.popUp(this.SearchInfo) : this.defaultPopUp()))) : null;
    }
}
// static propTypes = {
